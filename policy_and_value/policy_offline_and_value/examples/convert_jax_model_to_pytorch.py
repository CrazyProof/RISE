...
import openpi_value.models.gemma
import openpi_value.models.model
import openpi_value.models.pi0_config
import openpi_value.models_pytorch.pi0_pytorch
from openpi_value.training import utils
...
def slice_initial_orbax_checkpoint(checkpoint_dir: str, restore_precision: str | None = None):
    ...
    params = openpi_value.models.model.restore_params(
...
def convert_pi0_checkpoint(
    checkpoint_dir: str, precision: str, output_path: str, model_config: openpi_value.models.pi0_config.Pi0Config
):
    """
    ...
    action_expert_config = openpi_value.models.gemma.get_config("gemma_300m")
    ...
    # Instantiate model
    pi0_model = openpi_value.models_pytorch.pi0_pytorch.PI0Pytorch(model_config)
